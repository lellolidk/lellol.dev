...
<head>
    ...
    <title>lellolidk</title>
    <!-- ADD THIS LINE FOR THE FAVICON -->
    <link rel="icon" type="image/png" href="assets/lellol.png">
    ...
    <style>
        * {
        ...
        .bg-btn { cursor: pointer; padding: 4px 8px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); background: rgba(255,255,255,0.1); color: #fff; font-family: 'Orbitron', sans-serif; font-size: 10px; letter-spacing: 1px; }
...
<body onload="initMedia()">
    ...
    <div class="container">
        <video id="background" autoplay loop muted playsinline webkit-playsinline><source src="assets/background.mp4" type="video/mp4"></video>
        ...
        <div id="profile-block">
            <div class="profile-header">
                ...
                <div class="profile-info">
                    <div class="name-and-badges">
                        <div class="name-container"><div id="profile-name">lellolidk</div></div>
                        <div class="badge-group">
                            <div class="badge-container"><img src="assets/verified.gif" alt="badge2" class="badge"><span class="tooltip">Verified</span></div>
                            <div class="badge-container"><img src="assets/owner.png" alt="badge1" class="badge"><span class="tooltip">Owner</span></div>
                            <div class="badge-container"><img src="assets/waguribadge.png" alt="badge1" class="badge"><span class="tooltip">Waguri Kaoruko</span></div>
            ...
            <div class="profile-footer">
                <div class="social-links">
                    <a href="https://www.roblox.com/users/878683862/profile" target="_blank"><img src="assets/roblox.png" alt="GitHub" class="social-icon"></a>
                    <a href="https://youtube.com/@lellolidk" target="_blank"><img src="assets/youtube.png" alt="YouTube" class="social-icon"></a>
                    <a href="https://tiktok.com/@lellolidk" target="_blank"><img src="assets/tiktok.png" alt="TikTok" class="social-icon"></a>
                    <a href="https://steamcommunity.com/id/lellol" target="_blank"><img src="assets/steam.png" alt="Steam" class="social-icon"></a>
                    <a href="https://twitch.tv/lellolidk" target="_blank"><img src="assets/twitch.png" alt="Twitch" class="social-icon"></a>
                    <a href="https://instagram.com/lellolidk" target="_blank"><img src="assets/instagram.png" alt="Instagram" class="social-icon"></a>
                    <a href="https://x.com/lellolidk1" target="_blank"><img src="assets/x.png" alt="X/Twitter" class="social-icon"></a>
                    <a href="https://t.me/lellolidk" target="_blank"><img src="assets/telegram.png" alt="Telegram" class="social-icon"></a>
                </div>
                ...
                <div class="footer-bottom-row">
                    ...
                    <div class="location-info"><svg class="location-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg><span>Berlin, Germany</span><span class="info-separator">|</span><span id="local-time">--:--:--</span></div>
                </div>
            </div>
        </div>
        <div class="controls-dock">
            <div class="bg-switch">
                <button id="bg-prev" class="bg-btn">Prev</button>
                <button id="bg-next" class="bg-btn">Next</button>
            </div>
            <div class="volume-control"><svg id="volume-icon" class="volume-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"></path></svg><input id="volume-slider" class="slider" type="range" min="0" max="1" step="0.01" value="0.3"></div>
            <div class="transparency-control"><svg id="transparency-icon" class="transparency-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg><input id="transparency-slider" class="slider" type="range" min="0" max="1" step="0.01" value="0.6"></div>
        </div>
